...
new Glider(document.querySelectorAll('.glider')[0], {
  ...
  //ข้อความ
  var content = {
    "name": ["Forward thrust appearance: the color-contrasting wheel arch trims emphasize the offroad look. Supported by a long roof edge spoiler, which also flanks the rear window at the side, the steeply raked D pillars of the body line a dynamic optic.", 
      "","The format of the aluminum wheels ranges from 18-19 inch – depending on the exterior trim – up to 20 inch in diameter.",
      "Depending on the position of the rear seats and backrests, the luggage compartment capacity totals 530 or 675 liters (18.7/23.8 cu ft).",
      "","Depending on the position of the rear seats and backrests, the luggage compartment capacity totals 530 or 675 liters (18.7/23.8 cu ft). *This photo for advertising only",
      "With the backrests folded down the figure rises to 1,525 liters (53.9 cu ft). *This photo for advertising only",
      "Smartphone interface & MMI Radio plus 8.8 inch.","","Audi drive select and dual-zone climate control. *This photo for advertising only",
  ...
  function change_image(number) {
    if (number == 1) {
      document.getElementsByClassName("picture_exterior")[0].src = "Image+Site/Q8/New Q8/3.1.webp";
      checking_active(number);
    }
    else if (number == 2) {
      document.getElementsByClassName("picture_exterior")[0].src = "Image+Site/Q8/New Q8/3.2.webp";
      checking_active(number);
    }
    else if (number == 3) {
