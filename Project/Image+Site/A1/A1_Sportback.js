...
new Glider(document.querySelectorAll('.glider')[0], {
  ...
  //ข้อความ
  var content = {
    "name": ["With S line equipment, Audi has emphasized the sporty character even more through numerous features.",
             "Spacious, sporty, emotive. The new Audi A1 Sportback. *This clip vdo for advertising only.",
             "The new A1 Sportback also emphasizes a resemblance to the Audi Ur-quattro and Sport quattro when viewed from the side: The wide, flat sloping C-pillar seems to push the car forward even while standing still.",
             "The body of the new Audi A1 Sportback includes components made out of hot-formed steel that form the backbone of the passenger cell.",
             "This photo for advertising only","","The interior of the new Audi A1 Sportback is accordingly driver-focused, with its emotive design."
